            ...
            modelBuilder.Entity("eMentor.Entities.HardCode", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "UserRole", Value = 0 },
                        new { Id = 2, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Admin", ParentId = "UserRole", Value = 1 },
                        new { Id = 3, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Teacher", ParentId = "UserRole", Value = 2 },
                        new { Id = 4, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Student", ParentId = "UserRole", Value = 3 },
                        new { Id = 5, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Gender", Value = 0 },
                        new { Id = 6, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Male", ParentId = "Gender", Value = 1 },
                        new { Id = 7, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Female", ParentId = "Gender", Value = 2 },
                        new { Id = 8, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Other", ParentId = "Gender", Value = 3 },
                        new { Id = 9, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "CourseType", Value = 0 },
                        new { Id = 10, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Design", ParentId = "CourseType", Value = 1 },
                        new { Id = 11, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Drawing", ParentId = "CourseType", Value = 2 },
                        new { Id = 12, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Language", ParentId = "CourseType", Value = 3 },
                        new { Id = 13, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Math", ParentId = "CourseType", Value = 4 },
                        new { Id = 14, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Programming", ParentId = "CourseType", Value = 5 },
                        new { Id = 15, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Science", ParentId = "CourseType", Value = 6 },
                        new { Id = 16, Created = new DateTime(2019, 12, 17, 17, 43, 54, 182, DateTimeKind.Utc), IsDeactivate = false, Modified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Psycho", ParentId = "CourseType", Value = 7 }
                    );
                });
