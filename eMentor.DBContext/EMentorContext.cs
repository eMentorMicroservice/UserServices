...
namespace eMentor.DBContext
{
    public class EMentorContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(new User { Id = index++, UserName = "Student1", Email = "student1@gmail.com", FullName = "St 1", Salt = salt, PassCode = UtilCommon.GeneratePasscode("123456x@X", salt), Gender = Gender.Other, Role = UserRole.Teacher, Phone = "0132666666", IsDeactivate = false, IsFirstLogin = false, IsHardCode = true });
